const Nord = `
  --activityBar-activeBackground: #3b4252;
	...
	--activityBar-hoverForeground: #d8dee9;
	...
	--titleBar-border: 1px solid #2e344000;
	--titleBar-foreground: #d8dee9;

	--arrowFunction: #81a1c1;
	--asterisk: #88c0d0;
	--brackets: #8fbcbb;
	--className: #8fbcbb;
	--colon: #d8dee9;
	--comment: #616e88;
	--constKeyword: #81a1c1;
	--contact-border: #88c0d0;
	--contactButton-background: #88c0d0;
	--contactButton-foreground: #ffffff;
	--contactButton-hoverBackground: #88c0d0f1;
	--contact-error: #88c0d0;
	--equalSign: #81a1c1;
	--exportDefault: #81a1c1;
	--exportedVariable: #88c0d0;
	--exportStatement: #81a1c1;
	--fontStyle: normal;
	--importName: #d8dee9;
	--importStatement: #81a1c1;
	--importFrom: #81a1c1;
	--importPackage: #a3be8c;
	--key: #d8dee9;
	--parenthesis: #8fbcbb;
	--projectCard: #3b4252;
	--quotations: #d8dee9;
